...
export async function getRecommendedUsers(req,res){
    try{
        ...
        console.error('Error int getReccomendedUsers',error);
...
export async function acceptFriendRequest(req,res){
    try{
        ...
        if(friendRequest.recipient.toString()!==req.user.id){
            return res.status(401).json({message:"You are not authoruzed to accept this friend request"});
        }
        ...
        //$addToSet:adds element to an array only if it is not already present
